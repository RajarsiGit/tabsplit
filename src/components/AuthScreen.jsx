  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-50 dark:bg-gray-900 px-4">
      <div className="w-full max-w-sm rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-8 shadow-sm">
        ...
        <h1 className="mb-1 text-center text-2xl font-bold text-brand-600 dark:text-brand-400">TabSplit</h1>
        ...
        <div className="my-4 flex items-center gap-3">
          ...
          <span className="text-xs uppercase text-gray-400 dark:text-gray-500">or</span>
          <div className="h-px flex-1 bg-gray-200" />
        </div>

        <a
          href={authApi.githubLoginUrl}
          className="flex w-full items-center justify-center gap-2 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 py-2 text-sm font-semibold text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-900"
        >
        ...
        <button
          type="button"
          className="mt-4 w-full text-center text-sm text-brand-600 dark:text-brand-400 hover:underline"
          onClick={() => {
